...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items:[
      ...
      { id:'alliance',        icon:'🤝',                        label:'İttifak',    rgb:'201,162,39' },
      { id:'world',           icon:'🌍',                        label:'Dünya',      rgb:'201,162,39' },
      ...
      { id:'wiki',            icon:'📚',                        label:'Wiki',       rgb:'201,162,39' },
    ],
  },
  {
    ...
    items:[
      ...
      { id:'dm',           icon:'📬', label:'Mesaj',     rgb:'201,162,39'  },
      { id:'players',      icon:'👥', label:'Oyuncular', rgb:'201,162,39'  },
      { id:'social',       icon:'📱', label:'Sosyal',    rgb:'136,147,161' },
      { id:'newspaper',    icon:'📰', label:'Gazete',    rgb:'201,162,39'  },
