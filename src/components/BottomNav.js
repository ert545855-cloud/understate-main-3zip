      ...
      {openGroup && currentGroup && (
        <>
          <div
            ...
            style={{position:'fixed',inset:0,zIndex:940,background:'rgba(0,0,0,0.55)'}}
          />
          <div style={{
            position:'fixed', bottom:`calc(${navH}px + env(safe-area-inset-bottom,0px))`,
            left:'50%', transform:'translateX(-50%)',
            width:'min(100vw, 480px)', zIndex:950,
            background:'#1B212B',
            borderTop:`2px solid ${GOLD}`,
            borderRadius:'16px 16px 0 0',
            padding:'14px 12px 10px',
            boxShadow:'0 -8px 40px rgba(0,0,0,0.6)',
            maxHeight:'min(58vh, calc(100dvh - 220px))', overflowY:'auto',
