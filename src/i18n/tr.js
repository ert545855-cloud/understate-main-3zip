...
window.LANG_TR = {
  ...
  // === EconomyScreen ===
  stockMarket:'Borsa', portfolio:'Portföy', buy2:'Al', sell2:'Sat',
  myPortfolio:'Portföyüm', companyList:'Şirketler', bankLabel:'Banka',
  deposit2:'Yatır', withdraw2:'Çek', interest:'Faiz', balance:'Bakiye',
  // === Social ===
  ...
  doRegister:'→ Hesap Oluştur', orContinueWith:'veya',
  // === Errors ===
