...
// Altın paketleri (fiyat TL, gerçek ödeme entegrasyonu placeholder)
const UC_PACKAGES = [
  { id: 'uc_50',   uc: 50,   price: 9.99,   label: '50 Altın',   bonus: 0,    icon: '💎' },
  { id: 'uc_150',  uc: 150,  price: 24.99,  label: '150 Altın',  bonus: 10,   icon: '💎' },
  { id: 'uc_350',  uc: 350,  price: 49.99,  label: '350 Altın',  bonus: 30,   icon: '💎' },
  { id: 'uc_750',  uc: 750,  price: 99.99,  label: '750 Altın',  bonus: 75,   icon: '💎' },
  { id: 'uc_1500', uc: 1500, price: 179.99, label: '1500 Altın', bonus: 200,  icon: '💎' },
  { id: 'uc_3000', uc: 3000, price: 299.99, label: '3000 Altın', bonus: 500,  icon: '💎' },
];

const VIP_PACKAGES = [
  { id: 'vip_30',  days: 30,  price: 49.99,  label: '1 Aylık VIP',  perks: ['%2 banka faizi', 'Özel çerçeve', '+50% XP'] },
  { id: 'vip_90',  days: 90,  price: 129.99, label: '3 Aylık VIP',  perks: ['%2 banka faizi', 'Özel çerçeve', '+50% XP', 'Aylık 100 Altın'] },
  { id: 'vip_365', days: 365, price: 399.99, label: 'Yıllık VIP',   perks: ['%2 banka faizi', 'Özel çerçeve', '+50% XP', 'Aylık 150 Altın', 'Özel rozet'] },
];
...
// POST /api/store/purchase/uc — Altın satın al (simüle — gerçek ödeme entegrasyonu hazır değil)
router.post('/purchase/uc', authenticateToken, async (req, res) => {
  try {
    ...
    const newCoins = (user.altin || 0) + totalUC;

    await db.query(`UPDATE users SET altin = $1, updated_at = NOW() WHERE id = $2`, [newCoins, userId]);
    ...
    console.error('[store] Altın purchase error:', err.message);
